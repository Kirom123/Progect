...
namespace _1C_winForm {
    ...
    public partial class DataBaseDataSet : global::System.Data.DataSet {
        ...
        public partial class ProductsDataTable : global::System.Data.TypedTableBase<ProductsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ProductsRow AddProductsRow(int UserId, string ProductName) {
...
namespace _1C_winForm.DataBaseDataSetTableAdapters {
    ...
    public partial class ProductsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Products] WHERE (([Id] = @Original_Id) AND ([UserId] = @Origin" +
                "al_UserId) AND ([ProductName] = @Original_ProductName))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Products] ([UserId], [ProductName]) VALUES (@UserId, @ProductN" +
                "ame);\r\nSELECT Id, UserId, ProductName FROM Products WHERE (Id = SCOPE_IDENTITY()" +
                ")";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Products] SET [UserId] = @UserId, [ProductName] = @ProductName WHER" +
                "E (([Id] = @Original_Id) AND ([UserId] = @Original_UserId) AND ([ProductName] = " +
                "@Original_ProductName));\r\nSELECT Id, UserId, ProductName FROM Products WHERE (Id" +
                " = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::_1C_winForm.Properties.Settings.Default.DataBaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, UserId, ProductName FROM dbo.Products";
        ...
        public virtual int Delete(int Original_Id, int Original_UserId, string Original_ProductName) {
        ...
        public virtual int Insert(int UserId, string ProductName) {
        ...
        public virtual int Update(int UserId, string ProductName, int Original_Id, int Original_UserId, string Original_ProductName, int Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int UserId, string ProductName, int Original_Id, int Original_UserId, string Original_ProductName) {
            return this.Update(UserId, ProductName, Original_Id, Original_UserId, Original_ProductName, Original_Id);
        }
    }
